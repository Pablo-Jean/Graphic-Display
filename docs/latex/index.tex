...
\end{DoxyItemize}\hypertarget{index_autotoc_md3}{}\doxysection{\texorpdfstring{🗂️ API Reference}{🗂️ API Reference}}\label{index_autotoc_md3}
Access the Link \href{https://pablo-jean.github.io/Graphic-Display}{\texttt{ Graphic Display API Reference}} to see detailed information about functions, structs and more.\hypertarget{index_autotoc_md4}{}\doxysection{\texorpdfstring{🛠️ Installation}{🛠️ Installation}}\label{index_autotoc_md4}
...
Do not forget to remove examples from source code path \+:).\hypertarget{index_autotoc_md5}{}\doxysection{\texorpdfstring{🚀 Usage}{🚀 Usage}}\label{index_autotoc_md5}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{GraphicDisplay_8c_a058b61d16a02b94864bd04314ddbea6d}{GD\_Init}}(\&Graphic,\ \&Graphic\_Params);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{GraphicDisplay_8c_abbd368ffa7d5d787e5c4aaa64e5e81f2}{GD\_UpdateScreen}}(\&Graphic);}
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ You\ do\ not\ need\ to\ call\ the\ device\ driver\ refresh,\ Graphic\ Display\ library\ to\ this\ for\ you.}}
\DoxyCodeLine{\}}

\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{💡 Examples}{💡 Examples}}\label{index_autotoc_md6}
You can find various examples of using the Graphic Display library in the \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}examples\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} directory. These examples cover different use cases and demonstrate the library\textquotesingle{}s capabilities.\hypertarget{index_autotoc_md7}{}\doxysection{\texorpdfstring{🤝 Contributing}{🤝 Contributing}}\label{index_autotoc_md7}
We welcome contributions to the Graphic Display library! If you find any issues or have ideas for improvements, please feel free to submit a pull request or open an issue on the \href{https://github.com/pablo-jean/graphic-display}{\texttt{ Git\+Hub repository}}.\hypertarget{index_autotoc_md8}{}\doxysection{\texorpdfstring{🛠️ Creating Your Driver}{🛠️ Creating Your Driver}}\label{index_autotoc_md8}
...
To see what you need to do, check the API reference.\hypertarget{index_autotoc_md9}{}\doxysection{\texorpdfstring{📄 License}{📄 License}}\label{index_autotoc_md9}
Graphic Display is released under the \+MIT License. Feel free to use, modify, and distribute the library as per the terms of the license.\hypertarget{index_autotoc_md10}{}\doxysection{\texorpdfstring{Credits}{Credits}}\label{index_autotoc_md10}
