...
\Hypertarget{index_md_README}%
 \hypertarget{index_autotoc_md11}{}\doxysection{🔍 About the Library}\label{index_autotoc_md11}
Graphic Display is a C library designed for controlling monochromatic displays without any chipset or microcontroller dependency. This library allows you to use any display by providing a driver logic, making it a versatile solution for your project.\hypertarget{index_autotoc_md12}{}\doxysection{✨ Features}\label{index_autotoc_md12}
...
\item {\bfseries{Independent Drivers}}\+: The drivers of this libraries is builded thinking on a independency with the middle layer (\mbox{\hyperlink{GraphicDisplay_8h}{Graphic\+Display.\+h}}), allowing you to use in more advanced graphic libraries, like \href{https://github.com/lvgl/lvgl}{\texttt{ LVGL}}.
\end{DoxyItemize}\hypertarget{index_autotoc_md13}{}\doxysection{🗂️ API Reference}\label{index_autotoc_md13}
Access the Link \href{https://pablo-jean.github.io/Graphic-Display}{\texttt{ Graphic Display API Reference}} to see detailed information about functions, structs and more.\hypertarget{index_autotoc_md14}{}\doxysection{🛠️ Installation}\label{index_autotoc_md14}
...
\item {\ttfamily \#include \char`\"{}\+Graphic\+Display.\+h\char`\"{}}.
\item Link the library to your project during compilation.
\end{DoxyEnumerate}

Do not forget to remove examples from source code path \+:).\hypertarget{index_autotoc_md15}{}\doxysection{🚀 Usage}\label{index_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md16}{}\doxysection{💡 Examples}\label{index_autotoc_md16}
You can find various examples of using the Graphic Display library in the~{\bfseries{examples}}~directory. These examples cover different use cases and demonstrate the library\textquotesingle{}s capabilities.\hypertarget{index_autotoc_md17}{}\doxysection{🤝 Contributing}\label{index_autotoc_md17}
We welcome contributions to the Graphic Display library! If you find any issues or have ideas for improvements, please feel free to submit a pull request or open an issue on the~\href{https://github.com/pablo-jean/graphic-display}{\texttt{ Git\+Hub repository}}.\hypertarget{index_autotoc_md18}{}\doxysection{🛠️ Creating Your Driver}\label{index_autotoc_md18}
...
To see what you need to do, check the API reference.\hypertarget{index_autotoc_md19}{}\doxysection{📄 License}\label{index_autotoc_md19}
Graphic Display is released under the~MIT License. Feel free to use, modify, and distribute the library as per the terms of the license.\hypertarget{index_autotoc_md20}{}\doxysection{Credits}\label{index_autotoc_md20}
